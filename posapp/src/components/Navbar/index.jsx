    ...
    <>
      <nav className="navbar navbar-expand-lg bg-body-tertiary sticky-top">
        <div className="container-fluid">
          <a className="navbar-brand text-center d-flex justify-content-around" href="#">
            <svg
            ...
            <div className="d-flex flex-column mx-2">
              <h6 className="mb-0" style={{ color: "#FE9F43" }}>EASY</h6>
          ...
          <div className="d-flex justify-content-end gap-3 flex-shrink-1 navbar-other-items">
            ...
            >
              <button
                ...
                onClick={() => setOpenClosingModal(true)}
              >
                Close Shift
              </button>
            </div>
      ...
      {/* Rendered outside nav so backdrop covers the full page */}
      {openClosingModal && (
        <ClosingModal
